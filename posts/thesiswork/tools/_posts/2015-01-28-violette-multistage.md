...
3. Iteratively click on any of the generated code stages to introduce a subset of the given Java code example's behavior. E.g., Click stages in any order.
3.1 Open any hidden code blocks as you go along, and then try to understand its enclosed elements.    
