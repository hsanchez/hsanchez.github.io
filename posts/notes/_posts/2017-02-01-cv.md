...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          ...
          <strong>multi-LLM chemistry estimation</strong> as methods for improving
          ...
          tasks. I focus on applied AI research: turning model, retrieval, and
          multi-agent methods into evaluated systems that extract structure from
          messy domain data and support high-stakes scientific and engineering
          workflows. I apply <strong>AI assurance</strong> and <strong>AI red
          teaming</strong> to ensure these systems are reliable and robust in
          high-stakes domains. Strong track record of translating ML research
          ...
          introspecting social-cyber operations using deep learning.</span>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed multi-LLM workflows for healthcare data analysis, formalization, and knowledge composition, and built neurosymbolic AI and RAG-based methods for automatic generation of formal representations from natural language.</span>
        </div>
    </div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Researched inference-time optimization for compound software tasks — automated program repair and code generation — developing methods for optimal multi-LLM collaboration, Multi-LLM Chemistry estimation, and probabilistic consensus for reliable and consistent collective inference.</span>
        </div>
    </div>
    <div class="entry">
