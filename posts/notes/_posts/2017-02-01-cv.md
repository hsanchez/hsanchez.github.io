...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          <span class="deemph">AI researcher and technical leader at the intersection 
          of AI and software engineering, focused on the <strong>AI reliability problem</strong>: 
          ensuring AI systems behave correctly, consistently, and safely in high-stakes environments.
          My research centers on <strong>multi-LLM collaboration optimization, LLM Chemistry 
          and multi-LLM consensus estimation</strong> for model recommendation and output aggregation,
          which I have applied through <strong>agentic AI workflows</strong> to data analysis, 
          specification learning, code generation, and program repair, with a focus on cost-optimized, 
          workflow-aware planning for compound software tasks. I combine these with <strong>AI evaluation 
          and benchmarking, AI assurance, AI red teaming, and static/dynamic program analysis</strong>
          to stress-test reliability under realistic and adversarial conditions. What distinguishes my work 
          is a proven ability to translate research into practice: turning model, retrieval, and 
          multi-agent methods into evaluated systems that extract structure from messy domain data 
          and support high-stakes scientific and engineering workflows, and <strong>developing rigorous 
          evaluation frameworks</strong> to measure their effectiveness. Additional background in 
          modeling and introspecting social-cyber operations using modern deep learning.</span>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <!--<span class="deemph">Spearheading research into inference-time optimization for compound tasks.</span>-->
        </div>
    </div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed a post-training framework for multi-LLM collaboration optimization — including Multi-LLM Chemistry estimation and Multi-LLM consensus mechanisms — to improve reliability and consistency across complex reasoning tasks. Designed benchmarks and evaluation methods to measure collective model performance and quantify uncertainty in multi-agent outputs.</span>
        </div>
    </div>
    <div class="entry">
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Researched inference-time optimization for compound software tasks — automated program repair and code generation — developing methods for optimal multi-LLM collaboration, multi-LLM chemistry estimation, and multi-LLM consensus for reliable and consistent collective inference.</span>
        </div>
    </div>
    <div class="entry">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed machine learning, large-scale graph mining, and dynamic program analysis methods for open-source software security under DARPA MUSE, and designed integration and verification methods for systems of systems in distributed environments under DARPA SoSITE.</span>
        </div>
    </div>
    <div class="entry">
