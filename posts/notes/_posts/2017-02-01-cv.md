	...
	<div class="section">
			...
			<div class="entry">
				...
				<div class="item">
					...
					<span class="deemph">Combine big data analytics with program analysis to develop radically different approaches for automatically designing and constructing programs.</span>
				</div>
			</div>
			...
			<div class="entry">
				...
				<div class="item">
					...
					<span class="deemph">Work on leveraging large scale program repository mining techniques for program repair and synthesis.</span>
				</div>
			</div>
