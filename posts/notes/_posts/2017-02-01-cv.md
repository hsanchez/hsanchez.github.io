...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          <span class="deemph">AI researcher and technical leader working on the reliability of multi-agent 
          LLM systems — how to get multiple AI models to collaborate, evaluate each other, and produce 
          trustworthy results under real-world and adversarial conditions. Track record of moving this 
          research from prototype to deployed systems in scientific, healthcare, and cybersecurity domains, 
          backed by DARPA/IARPA/ARPA-H-funded research, patents, and peer-reviewed publications.</span>
        </div> <!-- item -->
    </div> <!-- entry -->
    ...
    <div class="entry">
        <div class="skills-grid">
          ...
          <div>AI-assisted Scientific Data Analysis</div>
...
<div class="section">
  ...
  <div class="entry">
    <div class="research-interests">
      <div>AI Reliability: ensuring AI systems behave correctly, consistently, and safely in high-stakes environments, through AI assurance, red teaming, error profiling, and systematic evaluation and benchmarking.</div>
      <div>Multi-LLM collaboration optimization: LLM Chemistry and multi-LLM consensus estimation for model recommendation and output aggregation, applied through agentic AI workflows.</div>
      <div>Static/dynamic program analysis for code analysis, transformation, and AI-driven reasoning.</div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed a post-training framework for multi-LLM collaboration — including LLM chemistry estimation and consensus mechanisms — to improve reliability across complex reasoning tasks, with benchmarks to measure collective performance and quantify uncertainty in multi-agent outputs.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed multi-LLM agentic workflows to extract structure from messy, domain-specific data — inferring JSON schemas and constraints, and synthesizing schema-compliant code for cross-device translation — with evaluation methods to profile hallucinated constraints and grounding failures.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2024 &ndash; 2025</div>
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed multi-LLM workflows for healthcare data analysis, formalization, and knowledge composition, using neurosymbolic AI to transform natural language into formal representations.</span>
        </div>
    </div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Researched inference-time optimization for compound software tasks (program repair, code generation), developing methods for multi-LLM collaboration, chemistry estimation, and consensus for reliable collective inference.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Led DARPA SocialCyber research to secure open-source software supply chains through neurosymbolic AI methods that model social-cyber threats. Developed multimodal, multi-task deep learning models for predicting developer behavior in social coding environments. Supervised a PhD research intern (Oregon State University, 2022).</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Integrated formal verification and program analysis for continuous assurance case construction under DARPA ARCOS. Established and led DARPA SocialCyber as Principal Investigator, defining the project vision for AI methods targeting open-source software supply chain security.</span>
        </div>
    </div>
    <div class="entry">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed <em>Big Code</em> analytics and machine learning methods for code-to-code search, API recommendation, and code synthesis under DARPA MUSE. Supervised a research intern on graph-based code analysis.</span>
        </div>
    </div>
    <div class="entry">
...
<div class="section">
  ...
  <div class="entry">
    <div class="item">
      <span class="bold">LLM-as-an-Oracle</span><br />
      <span class="deemph">Route, compare, and select between Judge and Verifier LLM evaluators (automatically); <a href="https://github.com/hsanchez/llm-as-an-oracle">https://github.com/hsanchez/llm-as-an-oracle</a> (Python, Vertex AI, OpenAI and Anthropic SDK).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
