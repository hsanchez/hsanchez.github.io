...
<div class="section">
  ...
  <div class="entry">
    <div class="research-interests">
        <div>Multi-LLM collaboration optimization and LLM chemistry estimation for compound AI and software tasks.</div>
        <div>Social-cyber security for protecting the integrity of open-source ecosystems.</div>
        <div>Debugging and fault localization techniques for detecting and understanding unexpected ML model failures.</div>
        <div>Software engineering for AI/ML, AI/ML for automated software engineering, and social cyber security.</div>
        <div>Crowdsourcing, re-imagined with collaborative LLMs, software tools, humans, and workflows.</div>
    </div>
  </div>
</div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Leading the development of a framework for optimizing multi-LLM collaboration in complex compound AI tasks by estimating LLM chemistry&mdash;the degree of collaborative compatibility among LLMs&mdash;and incorporating Bayes-driven consensus mechanisms for uncertainty quantification to enable the formation of efficient, effective, and stable LLM ensembles.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2024 &ndash; now</div>
        <div class="item">
            ...
            <span class="deemph">Developing multi-LLM strategies and cost-optimized workflows for extracting data types and constraints, inferring JSON schemas, and synthesizing schema-compliant code from diverse healthcare specifications.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2024 &ndash; now</div>
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Advancing the automatic generation of formal representations from natural language using neuro-symbolic AI and retrieval-augmented generation (RAG), and leading the development of multi-LLM (Agentic) workflows for healthcare data analysis, formalization, and composition.</span>
        </div>
    </div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Continuing to lead DARPA Social Cyber research to secure open-source software supply chains through dynamic behavior embeddings that model social-cyber threats, while developing multimodal, multi-task deep learning models for open-source software introspection and error profiling. Recruited, hired, and supervised research intern, providing daily technical mentorship and conducting formal performance evaluations.</span>
        </div>
    </div>
    <div class="entry">
...
<div class="section">
  ...
  <div class="entry">
    <div class="item">
      ...
      <span class="deemph">LLM Workflows for JSON Schema learning; <a href="https://github.com/SRI-CSL/aligner">https://github.com/SRI-CSL/aligner</a> (Python, PyTorch, Langchain, HuggingFace's SentenceTransformers).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
      <span class="bold">Collaborative LLMs</span><br />
      <span class="deemph">Optimal Multi-AI Collaboration; <a href="https://github.com/hsanchez/SRI-CSL/collm">https://github.com/hsanchez/SRI-CSL/collm</a> (Python, PyTorch, Ollama, Langchain).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
      <span class="bold">Yellow-Patch</span><br />
      <span class="deemph">A source code and patch analysis library; <a href="https://github.com/hsanchez/yellow-patch/">https://github.com/hsanchez/yellow-patch</a> (Python, PyTorch, HuggingFace's Accelerate, Pandas, SQL).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
