...
<div class="section">
  ...
  <div class="entry">
    <div class="research-interests">
        ...
        <div>AI assurance and error profiling for detecting and characterizing unexpected model failures.</div>
        <div>Static and dynamic program analysis for understanding and improving complex software systems.</div>
    </div>
  </div>
</div>
