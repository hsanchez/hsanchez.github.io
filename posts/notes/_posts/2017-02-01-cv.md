...
<div class="shifted">
	...
	<div class="section">
			...
			<div class="entry">
				...
				<div class="item">
					<span class="bold">(In Prep). Finding Diverse, Highly Representative Code Examples 
			...
			<div class="entry">
				<div class="year">2018</div>
				<div class="item">
					<span class="bold">(In Prep). Visualizing the Failure Landscape of Arbitrary Programs</span><br />
				</div>
			</div>						
