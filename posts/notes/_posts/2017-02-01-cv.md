...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          ...
          workflow-aware planning for compound software tasks. I combine these with <strong>static/dynamic 
          program analysis, AI assurance, AI red teaming, and AI evaluation and benchmarking</strong> to 
          stress-test reliability under realistic and adversarial conditions. What distinguishes my work 
