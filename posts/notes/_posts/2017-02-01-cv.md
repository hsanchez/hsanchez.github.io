...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          ...
          frameworks for model assessment. Additional background in social-cyber 
          security using deep learning.</span>
    ...
    <div class="entry">
        <div class="skills-grid">
          ...
          <div>LLM Chemistry Estimation for Model Selection, Routing, and Inference Optimization</div>
          <div>Applied AI Research for Scientific Workflows</div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            <span class="bold">SRI International</span> &middot; Menlo Park, CA <br />
            <span class="emph">Senior Computer Scientist</span>, Computer Science Laboratory <br/>
            <span class="deemph">Spearheading research into inference-time optimization for compound software tasks such as automated program repair and code generation, developing methodologies to improve model reliability, consistency, and performance, focusing on optimal multi-LLM collaboration, multi-hop reasoning, tool integration via MCP, probabilistic multi-LLM consensus, LLM chemistry estimation, prompt optimization, resulting in higher accuracy and reduced hallucinations compared to single-model inference. Led applied AI research from prototype to working systems, balancing model strategy, tool integration, evaluation design, and implementation details for compound software and data-transformation tasks.</span>
        </div>
    </div>
    <div class="entry">
