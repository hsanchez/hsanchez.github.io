...
<div class="shifted">
  <div class="section">
    <div class="entry">
      <div class="item">
        <span class="deemph">(Updated July 2026)</span>
      </div>
    </div>
  </div>
</div>
...
<div class="section">
    ...
    <div class="entry">
        <div class="item">
          <span class="deemph">AI researcher working on the reliability and safety of multi-agent LLM systems — how to get multiple AI
          models to optimally collaborate, coordinate and plan, evaluate each other, and produce trustworthy results
          under real-world and adversarial conditions. Track record of moving this research from prototype to
          deployed systems in scientific, healthcare, finance, and cybersecurity domains, backed by
          DARPA/IARPA/ARPA-H-funded research, patents, and peer-reviewed publications.</span>
        </div> <!-- item -->
    </div> <!-- entry -->
    ...
    <div class="entry">
        <div class="skills-grid">
          ...
          <div>Neuro-Symbolic AI for AI Specification Analysis</div>
          <div>AI-driven Code Analysis & Generation</div>
          <div>AI Harness Engineering</div>
          <div>AI-native Software Engineering</div>
          <div>Agentic Workflow-aware Planning</div>
          <div>Model Evaluation & Benchmarking</div>
          <div>Deep Learning Model Development & Training</div>
          <div>AI Safety & AI Red Teaming</div>
          <div>Programming Language Processing</div>
          <div>Uncertainty Quantification & Failure Analysis</div>
          <div>Social-Cyber Security</div>
          <!--<div>Multi-LLM Collaboration Optimization</div>
          <div>Multi-LLM Recommendation</div>
          <div>Agentic AI Workflows</div>
          <div>Compound AI & Workflow-aware Planning</div>
          <div>AI Evaluation & Benchmarking</div>
...
<div class="section">
  ...
  <div class="entry">
    <div class="research-interests">
      <div>Multi-model collaboration optimization and compatibility estimation.</div>
      <div>AI reliability, safety, and assurance.</div> 
      <div>Neuro-symbolic AI for AI specification analysis and bug finding</div>
...
<div class="section">
    ...
    <div class="entry">
        <div class="year">2026 &ndash; now</div>
        <div class="item">
            <span class="bold">Charles Schwab</span> &middot; San Francisco, CA <br />
            <span class="emph">AI Researcher</span>, AI.x Group <br/>
        </div>
    </div>
...
<div class="section">
    ...
    <div class="entry">
        <div class="year">2023 &ndash; 2025</div>
        <div class="item">
            <span class="bold"><a href="https://arxiv.org/abs/2510.03930">Reliable Multi-AI Collaboration</a></span> (Team: SRI) <br />
            <span class="deemph">Developed a post-training framework for multi-model collaboration, using multi-model compatibility estimation and consensus mechanisms to improve collective reasoning and reliability; designed benchmarks to evaluate multi-agent performance and quantify uncertainty in collective outputs.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed multi-agent LLM workflows that coordinate specialized models to infer schemas and constraints from noisy, domain-specific data and synthesize schema-compliant code for cross-device translation; designed evaluations to characterize hallucinated constraints and grounding failures.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2024 &ndash; 2025</div>
        <div class="item">
            ...
            <span class="deemph">Developed Cyber-Specific Computational Cognitive Models (C3Ms) using self-supervised machine learning, Information Foraging Theory, and Fuzzy Cognitive Maps to model attacker decision-making in contested cyber environments.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2023 &ndash; 2025</div>
        <div class="item">
            ...
            <span class="deemph">Developed multi-agent LLM workflows for healthcare data analysis, formalization, and knowledge composition, using neuro-symbolic AI to transform natural language into formal representations.</span>
        </div>
    </div>
    <div class="heading">Selected Earlier Projects<sup>*</sup></div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Researched inference-time optimization for complex software engineering tasks, including program repair and code generation; developed methods for multi-model collaboration, compatibility estimation, and consensus to improve the reliability of collective inference.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Led DARPA SocialCyber research on securing open-source software supply chains using neuro-symbolic AI to model social-cyber threats. Developed multimodal, multi-task deep learning models to predict developer behavior in social coding environments. Supervised a PhD research intern (Oregon State University, 2022).</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed methods integrating formal verification and program analysis for continuous assurance case construction under DARPA ARCOS. Established and led DARPA SocialCyber as Principal Investigator, defining the research vision and technical direction for AI-driven open-source software supply chain security.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed machine learning, large-scale graph mining, and dynamic program analysis methods for open-source software security under DARPA MUSE. Designed integration and verification methods for systems of systems in distributed environments under DARPA SoSITE.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed <em>Big Code</em> analytics and machine learning methods for code-to-code search, API recommendation, and code synthesis under DARPA MUSE. Supervised a PhD research intern (UC Irvine, 2017).</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Developed learning-to-rank models for large-scale code search and recommendation, and lightweight source code summarization techniques for improved program comprehension.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Made formal verification scalable and accessible to non-experts via crowd-sourced methods under DARPA CSFV.</span>
        </div>
    </div>
    <div class="entry">
        ...
        <div class="item">
          ...
          <span class="deemph">Empirically validated crowd-sourced formal verification methods, including online game-based approaches, under DARPA CSFV.</span>
        </div>
      </div>
      <div class="entry">
        ...
        <div class="item">
          ...
          <span class="deemph">Developed latent representation learning methods from social media data for multimodal cyberbullying detection.</span>
        </div>
      </div>
      <div class="entry">
        ...
        <div class="item">
          <span class="bold">University of California Santa Cruz</span> &middot; Santa Cruz, CA <br />
          <span class="emph">Research Assistant</span>, Software Introspection Laboratory <br/>
          <span class="deemph">Designed AI-guided, mixed-initiative tools for procedural robot component design.</span>
        </div>
      </div>
      <div class="entry">
        ...
        <div class="item">
          ...
          <span class="deemph">Developed semi-automatic index tuning methods for database management systems, contributing to the Kaizen index advisor (SIGMOD 2012).</span>
        </div>
      </div>
      <div class="entry">
        ...
        <div class="item">
          ...
          <span class="deemph">Built reporting and data visualization tools for business performance metrics.</span>
        </div>
      </div>
      <div class="entry">
        ...
        <div class="item">
          ...
          <span class="deemph">Developed and maintained distributed applications delivering over four million computer-based tests annually worldwide, supporting licensure, certification, and assessment markets.</span>
        </div>
      </div>
...
<div class="section">
  ...
  <div class="entry">
    ...
    <div class="item">
      <span class="bold">The Unreasonable Benchmark</span><br />
      <span class="emph">F. Perez-Cruz, B. Hitaj, G.M. Dimitri, O. Deb, A. M'Charrak, S. Srivastava, C. Kanan, A.K. Gupta, Z. Liu, T. Kumar, A.G. Bermudez, L. Alazraki, V. Mavroudis, Y. Xue, B. Matejek, S. Rajwal, A.K. Pandey, A.B. Bektas, A.B. Murthy, F. Chen, H.B. Giglou, J. D'Souza, H. Sanchez, M. Kraus, I. Lautenschlager, Z. Wang, X. He, and Hyun Song Shin</span> <br />
      <span class="deemph">Journal of Data-centric Machine Learning Research (<a href="https://openreview.net/forum?id=EkWAAfbGrh">DML</a>)</span>
    </div>
  </div>
  <div class="entry">
...
<div class="section">
  ...
  <div class="entry">
    <div class="item">
      <span class="bold">Multi-LLM-as-an-Oracle</span><br />
      <span class="deemph">A multi-LLM-based evaluation layer for open- and closed-ended tasks; <a href="https://github.com/hsanchez/llm-as-an-oracle">https://github.com/hsanchez/llm-as-an-oracle</a> (Python, Vertex AI, OpenAI and Anthropic SDK).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
      <span class="bold">Promptory</span><br />
      <span class="deemph">Git-Based Prompt Versioning System; <a href="https://github.com/hsanchez/promptory">https://github.com/hsanchez/promptory</a> (Python).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
      <span class="bold">dotagents</span><br />
      <span class="deemph">Package-driven configuration harness for repo-local AI coding environments; <a href="https://github.com/hsanchez/dotagents">https://github.com/hsanchez/dotagents</a> (Python, Nushell (Nu)).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
  ...
  <div class="entry">
    <div class="item">
      ...
      <span class="deemph">Multi-model compatibility estimation for multi-LLM recommendation; <a href="https://github.com/SRI-CSL/llm-chemistry">https://github.com/SRI-CSL/llm-chemistry</a> (Python, PyTorch, Pandas, Beartype, SciPy).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
      <span class="bold">Aligner</span><br />
      <span class="deemph">Multi LLM Workflows for JSON Schema learning and Schema-compliant code generation; <a href="https://github.com/SRI-CSL/aligner">https://github.com/SRI-CSL/aligner</a> (Python, PyTorch, Langchain, HuggingFace (Transformer), Docker, Anthropic's MCP SDK).</span>
    </div>
  </div>
  <div class="entry">
    <div class="item">
