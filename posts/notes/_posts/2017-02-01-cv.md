  ...
  <div class="entry">
    <div class="item">
      <ul class="research-list">
        <li></li>
        <li>Multi-LLM Collaboration for coding automation and software analytics.</li>
        <li>Program analysis methods for introspecting emergent AI/ML model behaviors</li>
        <li>AI/ML for software engineering, software engineering for AI/ML, and social-cyber security.</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="section">
  <div class="heading">Software Development<sup>*</sup></div>
