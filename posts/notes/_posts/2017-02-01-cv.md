...
<div class="section">
    ...
    on multi-LLM collaboration and LLMs chemistry estimation for data processing, knowledge extraction,
    information prediction, and source code analysis tasks. Skilled in
    prototyping novel solutions, solving complex technical problems, communicating across
    technical and non-technical audiences, and leading interdisciplinary teams in
...
<div class="section">
  ...
  <div class="entry">
    <div class="research-interests">
        <div>Multi-LLM collaboration optimization and LLMs chemistry estimation (LLM matchmaking) for complex, compound AI tasks such as agentic workflow specification, coding automation, and source code analysis</div>
        <div>Source code analysis and delta-debugging for identifying and characterizing emergent ML model misbehaviors.</div>
...
<div class="section">
    ...
    <div class="entry">
        ...
        <div class="item">
            ...
            <span class="deemph">Leading the development of a framework for optimizing multi-LLM collaboration in complex compound AI tasks by estimating LLM chemistry&mdash;to enable the formation of efficient, effective, and stable LLM ensembles.</span>
        </div>
    </div>
    <div class="entry">
        <div class="year">2024 &ndash; now</div>
